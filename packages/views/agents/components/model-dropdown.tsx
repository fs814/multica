    ...
    <div className="flex flex-col min-w-0">
      <div className="flex h-6 items-center justify-between">
        ...
        {!disabled && discoveryHint && (
          // `title` carries the raw discovery error when there is one: the hint
          // itself is a short generic label, and the underlying message is what
          // tells you whether the runtime refused, timed out, or returned junk.
          <span
