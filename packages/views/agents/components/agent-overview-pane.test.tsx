...
// Upstream removed its generic "Access has its own tab" case as
// implementation-only coverage (#7932). The Knot cases below are kept: they
// assert fork-specific routing — a Knot CLI agent gets a Routing tab wired to
// KnotConfigTab, while Knot HTTP deliberately configures from General and must
// NOT grow a second Routing tab.
