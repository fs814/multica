...
const PAGE_KEYWORDS: Record<WorkspacePageKey, string[]> = {
  ...
  workflows: ["workflows", "workflow", "templates", "graph", "工作流", "模板"],
  workflowIssues: ["workflow issues", "workflow tasks", "工作流任务", "工作流议题"],
  workflowInstances: ["workflow instances", "saved workflows", "instances", "工作流实例", "实例"],
  workflowRuns: ["workflow runs", "runs", "executions", "工作流运行", "运行", "执行"],
