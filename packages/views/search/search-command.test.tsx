...
vi.mock("@multica/core/paths", async (importOriginal) => {
  ...
  return {
    ...
    // The palette resolves each page's href through `p[page.key]()`, so a key
    // missing here throws `TypeError: p[page.key] is not a function` and takes
    // the whole file down — including the guard test that exists to catch
    // "a page was added but the surroundings were not wired up". The
    // `WorkspacePaths` return type is what stops this list from drifting again.
