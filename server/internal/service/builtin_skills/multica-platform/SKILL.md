...
description: "Use for Multica platform actions the runtime brief does not fully cover: issue and PR contracts, mentions, agents, squads, autopilots, projects, runtimes, execution, skill import. Not for the product code you are working on."
...
| `references/execution.md` | Knot HTTP remote workspace delivery and interrupted local execution |
