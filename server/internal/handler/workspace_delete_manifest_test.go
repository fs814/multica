...
var workspaceDeletionManifest = map[string]workspaceDeleteAction{
	...
	"project_memory_binding":             workspaceDelete,
	"project_memory_request":             workspaceDelete,
	"project_memory_scope":               workspaceDelete,
	"project_memory_task":                workspaceDelete,
	...
	"work_sync_receipt":                  workspaceDelete,
	"workflow_acceptance":                workspaceDelete,
	"workflow_callback_delivery":         workspaceDelete,
	...
	"workflow_debug_cleanup_object":      workspaceDelete,
