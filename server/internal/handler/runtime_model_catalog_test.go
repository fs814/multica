...
func TestInMemoryModelCatalogCache_RoundTrip(t *testing.T) {
	...
	if err := cache.Put(ctx, "rt-1", sampleCatalog(), nil, true, nil); err != nil {
		t.Fatalf("put: %v", err)
	}
...
func TestInMemoryModelCatalogCache_IsolatesNestedFields(t *testing.T) {
	...
	if err := cache.Put(ctx, "rt-1", source, nil, true, nil); err != nil {
		t.Fatalf("put: %v", err)
	}
...
func TestInMemoryModelCatalogCache_SkipsUncacheableResults(t *testing.T) {
	...
	if err := cache.Put(ctx, "rt-empty", nil, nil, true, nil); err != nil {
	...
	if err := cache.Put(ctx, "rt-unsupported", sampleCatalog(), nil, false, nil); err != nil {
	...
	if err := cache.Put(ctx, "", sampleCatalog(), nil, true, nil); err != nil {
...
func TestInitiateListModels_ForceSkipsCatalogCache(t *testing.T) {
	...
	if err := cache.Put(context.Background(), runtimeID, sampleCatalog(), unavailable, true, nil); err != nil {
...
func (failingModelCatalogCache) Put(context.Context, string, []ModelEntry, []UnavailableModelEntry, bool, []KnotAgentEntry) error {
	return nil
}
...
func TestInMemoryModelCatalogCache_RoundTripsUnavailableModels(t *testing.T) {
	...
	if err := cache.Put(ctx, "rt-1", sampleCatalog(), unavailable, true, nil); err != nil {
		t.Fatalf("put: %v", err)
	}
...
func TestInMemoryModelCatalogCache_RoundTripsKnotAgents(t *testing.T) {
	...
	if err := cache.Put(ctx, "rt-knot", sampleCatalog(), nil, true, agents); err != nil {
		t.Fatalf("put: %v", err)
	}
...
func TestInMemoryModelCatalogCache_OmitsKnotAgentsForOtherProviders(t *testing.T) {
	ctx := context.Background()
	cache := NewInMemoryModelCatalogCache()
	if err := cache.Put(ctx, "rt-claude", sampleCatalog(), nil, true, nil); err != nil {
		t.Fatalf("put: %v", err)
	}
