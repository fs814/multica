...
`, wsID, testUserID)
	...
	// Workflow runtime rows (fork-specific): DeleteWorkspace must cascade
	// through the whole workflow graph. dbfx.Insert registers deletion in
	// reverse creation order, so the FK chain unwinds without an explicit
	// teardown block.
	workflowTemplateID := dbfx.Insert(t, "workflow_template", testutil.Cols{
		"workspace_id":    wsID,
		"key":             "workspace-delete",
		"name":            "Workspace delete workflow",
		"created_by_type": "member",
		"created_by_id":   testUserID,
	})
	workflowVersionID := dbfx.Insert(t, "workflow_template_version", testutil.Cols{
		"workspace_id": wsID,
		"template_id":  workflowTemplateID,
		"version":      1,
		"definition":   testutil.Raw("'{}'::jsonb"),
	})
	workflowRunID := dbfx.Insert(t, "workflow_run", testutil.Cols{
		"workspace_id":        wsID,
		"template_id":         workflowTemplateID,
		"template_version_id": workflowVersionID,
		"source":              "manual",
		"idempotency_key":     "workspace-delete-run",
	})
	workflowStepID := dbfx.Insert(t, "workflow_step_instance", testutil.Cols{
		"workspace_id":   wsID,
	...
	dbfx.Insert(t, "workflow_submission", testutil.Cols{
		"workspace_id": wsID,
		"run_id":       workflowRunID,
		"step_id":      workflowStepID,
		"verdict":      "pass",
	})
	dbfx.Insert(t, "workflow_acceptance", testutil.Cols{
		"workspace_id": wsID,
		"run_id":       workflowRunID,
		"step_id":      workflowStepID,
	})
	dbfx.Insert(t, "workflow_event", testutil.Cols{
		"workspace_id":    wsID,
		"run_id":          workflowRunID,
		"step_id":         workflowStepID,
		"event_type":      "run.started",
		"idempotency_key": "workspace-delete-event",
		"actor_type":      "system",
	})
