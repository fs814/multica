...
var preMigrationHooks = map[string]preMigrationHook{
	...
	"512_issue_pool_policy_id_index":                        cleanupInvalidConcurrentIndexHook("issue_pool_policy_id_key"),
	"513_issue_pool_cycle_id_index":                         cleanupInvalidConcurrentIndexHook("issue_pool_cycle_id_key"),
	"514_issue_pool_item_id_index":                          cleanupInvalidConcurrentIndexHook("issue_pool_item_id_key"),
	"515_issue_pool_policy_autopilot_index":                 cleanupInvalidConcurrentIndexHook("issue_pool_policy_autopilot_key"),
	"516_issue_pool_cycle_idempotency_index":                cleanupInvalidConcurrentIndexHook("issue_pool_cycle_idempotency_key"),
	"517_issue_pool_item_active_issue_index":                cleanupInvalidConcurrentIndexHook("issue_pool_item_active_issue_key"),
	"518_issue_pool_cycle_autopilot_index":                  cleanupInvalidConcurrentIndexHook("issue_pool_cycle_autopilot_created_index"),
	"519_issue_pool_item_cycle_index":                       cleanupInvalidConcurrentIndexHook("issue_pool_item_cycle_index"),
